...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.grasset.service..*.*(..))")
    public void service() {}

    @Pointcut("execution(* com.grasset.rs..*.*(..))")
    public void rs() {}

    @Pointcut("execution(* com.grasset.main..*.*(..))")
    public void main() {}

    @Pointcut("within(com.grasset.interceptor.RestExceptionHandler)")
